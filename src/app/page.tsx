...
export default function ClientLandingPage() {
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    ...
    // Reset state after 4 seconds to allow clicking again if they navigate back
    setTimeout(() => {
    ...
    <div className="landing-wrapper">
      <header className="landing-header">
        <div className="container" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div className="logo-group">
            ...
            <p className="logo-subtitle">Mobiliário & Design</p>
          </div>
      ...
      <main className="landing-main">
        <div className="landing-content">
          <div className="editorial-tag">Curadoria Belcolore</div>
          <h2 className="editorial-title">
            Mobiliário Autoral e Projetos de Interiores Personalizados
          </h2>
          <p className="editorial-paragraph">
            Nossa equipe de designers está pronta para ajudar a projetar e transformar o seu espaço. 
            Clique no botão abaixo para iniciar o seu atendimento exclusivo direto via WhatsApp.
          </p>

          <div className="cta-container">
            <a 
              href="/go" 
              className={`whatsapp-cta-btn ${isRedirecting ? "disabled" : ""}`}
              onClick={handleClick}
              style={isRedirecting ? { opacity: 0.6, pointerEvents: "none" } : undefined}
            >
              {isRedirecting ? (
                <>
                  <span style={{
            ...
            <p className="cta-disclaimer">
              Você será direcionado para um de nossos especialistas activos.
            </p>
          </div>
        </div>
      </main>
      ...
      <footer className="landing-footer">
        <p>&copy; {new Date().getFullYear()} Belcolore Mobiliário. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
